...
{
    int error = 0;
    error += test_part<Triangulation,     Tile_index  >("out/test_DDT_d4/part");
    error += test_info<TriangulationInfo, PropertyInfo>("out/test_DDT_d4/info");
    error += test_info<TriangulationData, PropertyData>("out/test_DDT_d4/data");
